...
export default function Profile() {
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        setPhoto(reader.result); // Set the new photo URL
      };
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-12">
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="border p-4 md:-mt-32 rounded-md w-64 mx-auto">
                ...
                <div className="text-center mt-2">
                  ...
                  <button
                    className="text-blue-600 hover:underline text-sm focus:outline-none"
                    onClick={() => setPhoto("https://via.placeholder.com/150")} // Reset to default or placeholder image
                  >
                    Unset photo
                  </button>
                  {/* Hidden file input */}
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">
              We&apos;ll always let you know when your register data of missing
